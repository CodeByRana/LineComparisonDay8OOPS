package com.bridgelabz.linecom;
...
public class LineComparison {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter co-ordinates of 1st point of 2nd line ");
        System.out.println("x : ");
        x1 = sc.nextInt();
        System.out.println("y : ");
        y1 = sc.nextInt();
        System.out.println("Enter co-ordinates of 2nd point of 2nd line ");
        System.out.println("x : ");
        x2 = sc.nextInt();
        System.out.println("y : ");
        y2 = sc.nextInt();
